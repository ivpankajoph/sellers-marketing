...
import DashboardZoneLayout from '@/components/layout/DashboardLayout';
...
export default function WhatsTokenCardMain() {
  ...
  return (
    <DashboardLayout>
      {/* ✅ CORRECT: Standard padding, NO min-h-screen, NO full-viewport background */}
      <div className="p-6 space-y-12">
        ...
        <div className="bg-gradient-to-br from-green-50 via-white to-emerald-50 rounded-3xl p-8 relative overflow-hidden">
          {/* Background effects — confined to this card only */}
          ...
          <div className="mt-10 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-8 text-white shadow-lg">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-50">
                    Reach your customers with promotional offers and updates
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
